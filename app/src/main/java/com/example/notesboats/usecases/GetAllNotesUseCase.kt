...
@Singleton
class GetAllNotesUseCase @Inject constructor(@IoDispatcher dispatcher: CoroutineDispatcher, val notesRepository: NotesRepository): FlowUseCase<Unit,List<Notes>>(dispatcher) {
